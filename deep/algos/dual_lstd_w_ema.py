...
def make_train(config):
    ...
    def lstd_batch_update(lstd_state: Dict, transitions, features, next_features, traces, mean_rho, std_rho):        
        ...
        w_i = EMA(ema_w, lstd_state['w_i'], (A_inv @ b_i))
        w_e = (A_inv @ b_e)           
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            rho_scale = 1.0 / jnp.sqrt(sigma_state['N'])
            # Standardize Bonus
            ...
            v_i_opt = rho_scale * phi @ lstd_state['w_e']
            ...
            last_val_i_opt = rho_scale * last_phi @ lstd_state['w_e']
            ...
            if calc_true_values:
                ...
                # v_i_pred_opt = rho_scale * phi @ lstd_state['w_e']
