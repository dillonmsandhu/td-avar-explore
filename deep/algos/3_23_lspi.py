...
def make_train(config):
    ...
    def LSPI(lstd_state: Dict, transitions, features, next_features, traces, num_iters=3):
        ...
        Alternates between greedy policy improvement and LSTD evaluation.
        """
        ...
        def lspi_step(w_current, _):
            ...
            b_i_temp = helpers.EMA(alpha_fn_lstd_b(t), lstd_state["b"], b_batch)

            A_view = A_i_temp + Lambda_mat + reg
        ...
        # ------------------------------------------------------------
        # Permanently lock in the EMA updates using the final policy
