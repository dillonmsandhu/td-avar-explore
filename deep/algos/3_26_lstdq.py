...
SAVE_DIR = "3_26_cov_lstd_q" # Updated to reflect new run
...
def make_train(config):
    ...
    def LSTDQ(lstd_state: Dict, transitions, features, next_features, traces):
        ...
        # FIX: Ensure we use the intrinsic discount factor!
        γ = config["GAMMA_i"] 
