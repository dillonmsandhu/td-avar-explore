# LSTD with Optimistic Initialization and importance sampling weighting due to 1/d(s), which is estimated with the feature covariance.
# Intrinsic Value
...
def make_train(config):
    ...
    def lstd_batch_update(
        ...
        weighted_gram_batch = (
            jnp.einsum("bt, bti, btj->ij", lambda_s * is_weights, features, features)
        ...
        b_i_sample_opt = (1 - lambda_s)[..., None] * b_i_sample + (
            lambda_s * is_weights
        )[..., None] * lstd_state["V_max"] * features
