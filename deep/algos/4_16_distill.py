...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            # --- 3. SOLVE LSTD OVER EXTENDED BUFFER ---
            ...
            lstd_v_i = phi @ lstd_state["w"] * rho_scale
            lstd_next_v_i = next_phi @ lstd_state["w"]  * rho_scale
            lstd_v_i, lstd_next_v_i = jax.tree.map(lambda x: jnp.clip(x, 0, rho_scale/(1-config['GAMMA_i'])) , (lstd_v_i, lstd_next_v_i) )
            ...
            metric.update(
                {
                    ...
                    "intrinsiv": traj_batch.intrinsic_reward.mean(),
                    "intrinsic_rew_std": traj_batch.intrinsic_reward.std(),
