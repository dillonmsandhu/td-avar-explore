# fixes intrinsic reward scaling issue.
from core.imports import *
import core.helpers as helpers
import core.networks as networks

SAVE_DIR = "4_1_cov_lstd"
...
def make_train(config):
    ...
    def lstd_batch_update(lstd_state: Dict, transitions, features, next_features, traces):
            ...
            # ------------------------------------------------------------
            # done transitions get an extra absorb transitions whenever is_absorbing is set to true.
            ...
            # Add the "absorb" transitions
            num_absorbs = absorb_mask.sum()
            A_batch = (A_batch + A_absorb) / (batch_size + num_absorbs)
            b_batch = (b_batch + b_absorb) / (batch_size + num_absorbs)
