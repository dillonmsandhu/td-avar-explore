...
def make_train(config):
    ...
    REG_FINAL = config.get("A_REGULARIZATION_PER_STEP", 1e-5)
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            sigma_state = helpers.sigma_update(sigma_state, traj_batch, next_phi, alpha_fn(sigma_state['t']))
