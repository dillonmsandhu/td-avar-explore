...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            # Intrinsic Critic:
            traces = helpers._get_all_traces(phi, config['GAMMA'], config['GAE_LAMBDA'])
            ...
            gaes, targets = helpers.calculate_i_and_e_gae_two_critic_episodic(traj_batch, last_val, last_i_val, config["GAMMA"], config["GAE_LAMBDA"])
