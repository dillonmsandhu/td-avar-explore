...
def make_train(config):
    ...
    def get_scale_free_bonus(S_inv, features):
        ...
        return jnp.sqrt(jnp.maximum(0.0, bonus_sq))
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            eps = jnp.maximum(config['GRAM_REG'] / sigma_state["N"], 1e-9)
            ...
            rho_scale = config['BONUS_SCALE'] / jnp.sqrt(sigma_state["N"])
