...
def make_train(config):
    ...
    def lstd_batch_update(lstd_state: Dict, transitions, features, next_features, traces, alpha: float):
            ...
            k = A_batch_sum.shape[0]
            # Since A_i is a mean (mass = 1), regularization natively acts "per-step"
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            lstd_state = lstd_batch_update(lstd_state, traj_batch, phi, next_phi, traces, config.get("LSTD_LR", 0.064))
